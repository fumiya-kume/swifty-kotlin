...
| `String.toList()` / `toMutableList()` / `toTypedArray()` / `toSet()` / `asSequence()` | done | `kk_string_toList`, `kk_string_toMutableList`, `kk_string_toTypedArray`, `kk_string_asSequence`, `kk_string_asIterable` |
