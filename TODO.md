...
- [x] STDLIB-SEQ-FN-037: `firstOrNull` 関数の実装
...
- [x] STDLIB-SEQ-FN-049: `indexOfFirst` 関数の実装
...
- [x] STDLIB-IO-PATH-FN-014: `Path.createDirectory(attributes)` を追加する
...
- [x] STDLIB-IO-PATH-FN-018: `Path.createSymbolicLinkPointingTo(target, attributes)` を追加する
- [x] STDLIB-IO-PATH-FN-019: `createTempDirectory(prefix, attributes)` を追加する
- [x] STDLIB-IO-PATH-FN-020: `createTempDirectory(directory, prefix, attributes)` を追加する
- [ ] STDLIB-IO-PATH-FN-021: `createTempFile(prefix, suffix, attributes)` を追加する
- [x] STDLIB-IO-PATH-FN-022: `createTempFile(directory, prefix, suffix, attributes)` を追加する
...
- [x] STDLIB-JS-FN-023: `Array<T>.toJsArray()` を追加する
