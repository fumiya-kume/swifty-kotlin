...
/// Registers the Uuid class, companion factory methods/properties (random, parse, parseOrNull, parseHexOrNull, parseHexDashOrNull, NIL, LEXICAL_ORDER, SIZE_BITS, SIZE_BYTES),
