    ...
    func allowsProjectedReceiverUnsafeVariance(
        ...
        if let externalLinkName = sema.symbols.externalLinkName(for: candidate) {
            ...
            case "kk_list_contains", "kk_list_containsAll", "kk_list_indexOf", "kk_list_lastIndexOf",
                 ...
                 "kk_list_maxWith", "kk_list_maxWithOrNull",
                 "kk_list_minWith", "kk_list_minWithOrNull",
        ...
        case (knownNames.kotlinCollectionsListFQName, interner.intern("contains")),
             ...
             (knownNames.kotlinCollectionsListFQName, interner.intern("elementAtOrElse")),
             ...
             (knownNames.kotlinCollectionsListFQName, interner.intern("foldRight")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("foldRightIndexed")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("reduceRight")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("reduceRightIndexed")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("reduceRightIndexedOrNull")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("reduceRightOrNull")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("runningFoldIndexed")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("runningReduceIndexed")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("scanIndexed")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("takeWhile")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("dropLastWhile")),
             ...
             (knownNames.kotlinCollectionsListFQName, interner.intern("minBy")),
             ...
             (knownNames.kotlinCollectionsListFQName, interner.intern("maxOf")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("minOf")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("maxWith")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("maxWithOrNull")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("minWith")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("minWithOrNull")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("maxOfWith")),
             (knownNames.kotlinCollectionsListFQName, interner.intern("maxOfWithOrNull")),
