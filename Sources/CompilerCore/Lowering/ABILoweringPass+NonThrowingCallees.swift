...
extension ABILoweringPass {
    func nonThrowingCallees(interner: StringInterner) -> Set<InternedString> {
        Set([
            ...
            interner.intern("kk_op_floor_mod"),
            interner.intern("kk_op_lfloor_mod"),
            ...
            interner.intern("kk_string_format_locale"),
            ...
            interner.intern("kk_string_chunkedSequence"),
            ...
            interner.intern("kk_op_ffloor_mod"),
            ...
            interner.intern("kk_op_dfloor_mod"),
