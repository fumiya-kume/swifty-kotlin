...
extension ABILoweringPass {
    func nonThrowingCallees(interner: StringInterner) -> Set<InternedString> {
        Set([
            ...
            interner.intern("kk_string_encodeToByteArray"),
            interner.intern("kk_bytearray_decodeToString"),
            ...
            interner.intern("kk_emptyList"),
            interner.intern("kk_emptySet"),
            interner.intern("kk_emptyMap"),
            ...
            // Duration factory/accessor functions (STDLIB-585) — none of these throw.
            interner.intern("kk_duration_from_nanoseconds"),
            interner.intern("kk_duration_from_seconds"),
            interner.intern("kk_duration_from_milliseconds"),
            interner.intern("kk_duration_from_microseconds"),
            interner.intern("kk_duration_from_minutes"),
            interner.intern("kk_duration_from_hours"),
            interner.intern("kk_duration_inWholeMilliseconds"),
            interner.intern("kk_duration_inWholeSeconds"),
            interner.intern("kk_duration_inWholeNanoseconds"),
            interner.intern("kk_duration_toString"),
