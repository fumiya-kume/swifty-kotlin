...
extension ABILoweringPass {
    func nonThrowingCallees(interner: StringInterner) -> Set<InternedString> {
        Set([
            ...
            interner.intern("kk_url_new"),
            interner.intern("kk_url_new_relative"),
            interner.intern("kk_url_protocol"),
            interner.intern("kk_url_host"),
            interner.intern("kk_url_port"),
            interner.intern("kk_url_path"),
            interner.intern("kk_url_query"),
            interner.intern("kk_url_fragment"),
            interner.intern("kk_url_toURI"),
            interner.intern("kk_url_toExternalForm"),
            interner.intern("kk_url_sameFile"),
            interner.intern("kk_url_equals"),
            interner.intern("kk_url_hashCode"),
            interner.intern("kk_url_encode"),
            interner.intern("kk_url_decode"),
