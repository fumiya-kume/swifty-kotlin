...
final class ABILoweringPass: LoweringPass {
    ...
    func run(module: KIRModule, ctx: KIRContext) throws {
        let nonThrowingCallees: Set<InternedString> = Set([
            ...
            ctx.interner.intern("kk_string_contains_str"),
            ctx.interner.intern("kk_string_split"),
            ctx.interner.intern("kk_string_isNullOrEmpty"),
            ctx.interner.intern("kk_string_isNullOrBlank"),
            ...
            ctx.interner.intern("kk_flow_retain"),
            ctx.interner.intern("kk_flow_release"),
