...
public enum Expr: Equatable {
    ...
    case localFunDecl(name: InternedString, typeParams: [TypeParamDecl], valueParams: [ValueParamDecl], returnType: TypeRefID?, body: FunctionBody, isSuspend: Bool, range: SourceRange)
