...
final class KIRLoweringContext {
    ...
    var loopControlStack: [(continueLabel: Int32, breakLabel: Int32, userLabel: InternedString?)] = []
    ...
    struct ScopeSnapshot {
        ...
        let loopControlStack: [(continueLabel: Int32, breakLabel: Int32, userLabel: InternedString?)]
