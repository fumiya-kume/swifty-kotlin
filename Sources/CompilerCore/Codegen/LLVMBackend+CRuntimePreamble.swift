...
extension LLVMBackend {
    func cRuntimePreamble() -> [String] {
        [
            ...
            "}",
            "/* --- Flow stubs (P5-88) --- */",
            "static intptr_t kk_flow_create(intptr_t emitterFnPtr, intptr_t continuation) {",
            "  (void)continuation;",
            "  return emitterFnPtr;",
            "}",
            "static intptr_t kk_flow_emit(intptr_t flowHandle, intptr_t value, intptr_t continuation) {",
            "  (void)flowHandle; (void)continuation;",
            "  return value;",
            "}",
            "static intptr_t kk_flow_collect(intptr_t flowHandle, intptr_t collectorFnPtr, intptr_t continuation) {",
            ...
            "static intptr_t kk_dispatcher_default(void) { return KK_DISPATCHER_DEFAULT; }",
            "static intptr_t kk_dispatcher_io(void)      { return KK_DISPATCHER_IO; }",
            "static intptr_t kk_dispatcher_main(void)    { return KK_DISPATCHER_MAIN; }",
            "static intptr_t kk_with_context(intptr_t dispatcher, intptr_t blockFnPtr, intptr_t continuation) {",
            "  (void)dispatcher;",
            ...
            "static intptr_t kk_channel_create(intptr_t capacity) {",
            ...
            "  return (intptr_t)ch;",
            "}",
            "static intptr_t kk_channel_send(intptr_t handle, intptr_t value, intptr_t continuation) {",
            "  (void)continuation;",
            ...
            "  return value;",
            "}",
            "static intptr_t kk_channel_receive(intptr_t handle, intptr_t continuation) {",
            "  (void)continuation;",
            "  KKChannel* ch = (KKChannel*)(void*)handle;",
            ...
            "  return val;",
            "}",
            "static intptr_t kk_channel_close(intptr_t handle) {",
            "  KKChannel* ch = (KKChannel*)(void*)handle;",
            "  if (ch) ch->closed = 1;",
            "  return 0;",
            "}",
            "/* --- awaitAll stub (P5-135) --- */",
            "static intptr_t kk_await_all(intptr_t handlesArray, intptr_t count) {",
            "  (void)handlesArray; (void)count;",
            "  return 0;",
            "}",
            "/* vtable/itable dispatch helpers */",
            "typedef intptr_t (*KKVTableEntry)();",
            "static KKVTableEntry kk_vtable_lookup(intptr_t receiver, intptr_t slot) {",
            ...
            "  return vtable[slot];",
            "}",
            "static KKVTableEntry kk_itable_lookup(intptr_t receiver, intptr_t ifaceSlot, intptr_t methodSlot) {",
            "  if (!receiver || receiver == KK_NULL_SENTINEL) return (KKVTableEntry)0;",
            "  intptr_t* obj = (intptr_t*)(void*)receiver;",
            "  intptr_t typeInfo = obj[0];",
            "  if (!typeInfo) return (KKVTableEntry)0;",
