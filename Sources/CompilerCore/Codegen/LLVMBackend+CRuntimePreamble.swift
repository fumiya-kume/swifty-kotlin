...
extension LLVMBackend {
    ...
    func cRuntimeExternDeclarations() -> [String] {
        [
            ...
            "extern intptr_t iterator(intptr_t rangeRaw);",
            "extern intptr_t hasNext(intptr_t iterRaw);",
            "extern intptr_t next(intptr_t iterRaw);",
            ""
        ]
    }
    ...
    func cRuntimePreamble() -> [String] {
        [
            ...
            "  if (r->step < 0) { r->step = -stepVal; } else { r->step = stepVal; }",
            "  return rangeRaw;",
            "}",
            "__attribute__((weak)) intptr_t iterator(intptr_t rangeRaw) {",
            "  KKRange* r = (KKRange*)(void*)rangeRaw;",
            "  if (!r) return 0;",
            ...
            "  return (intptr_t)it;",
            "}",
            "__attribute__((weak)) intptr_t hasNext(intptr_t iterRaw) {",
            ...
            "  return 0;",
            "}",
            "__attribute__((weak)) intptr_t next(intptr_t iterRaw) {",
            "  KKRangeIterator* it = (KKRangeIterator*)(void*)iterRaw;",
            "  if (!it) return 0;",
