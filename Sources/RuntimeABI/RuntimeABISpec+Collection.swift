public extension RuntimeABISpec {
    ...
    static let collectionHOFFunctions: [RuntimeABIFunctionSpec] = {
        ...
        let before = [
            ...
            "kk_list_firstNotNullOf", "kk_list_firstNotNullOfOrNull", "kk_list_flatMap",
            "kk_list_any", "kk_list_none", "kk_list_all",
        ]
        ...
        return before.map { hofSpec($0) }
            ...
            + [
                ...
                sumOfSpec, sumBySpec, maxOrNullSpec, minOrNullSpec,
