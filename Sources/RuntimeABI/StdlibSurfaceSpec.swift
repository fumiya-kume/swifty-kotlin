...
private extension StdlibSurfaceSpec {
    ...
    static let sequenceHOFMembers: [StdlibSurfaceSpec] = [
        ...
        sequence("runningReduce", 1, "kk_sequence_runningReduce", returnStrategy: .list, lambdaExpectation: .none),
        ...
        sequence("runningReduce", 1, "kk_sequence_runningReduce", returnStrategy: .sequence, lambdaExpectation: .none),
