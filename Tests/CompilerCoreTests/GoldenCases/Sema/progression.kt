...
fun testCharProgression(): List<Char> = CharProgression.fromClosedRange('a', 'g', 2).toList()
...
fun testCharProgressionStep(): List<Char> = CharProgression.fromClosedRange('a', 'h', 1).step(3).toList()
