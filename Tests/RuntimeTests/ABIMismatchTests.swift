...
final class ABIMismatchTests: XCTestCase {
    ...
    func testStringFunctionCount() {
        ...
        XCTAssertEqual(RuntimeABISpec.stringFunctions.count, 166)
    }
    ...
    func testMathFunctionCount() {
        ...
        // Random ABI includes default, seeded, bounded numeric helpers, SecureRandom helpers, and explicit bit extraction.
        XCTAssertEqual(RuntimeABISpec.randomFunctions.count, 21)
    }
